...
export function getCartAnalyticsData(element, overrides = {}) {
  ...
  return {
    ...
    parentProductId: overrides.parentProductId ?? dataset.analyticsParentProductId,
    parentProductTitle: overrides.parentProductTitle ?? dataset.analyticsParentProductTitle,
...
export function pushCartDrawerAnalyticsEvent(eventName, data = {}) {
  ...
  const payload = {
    ...
    parent_product_title: data.parentProductTitle,
